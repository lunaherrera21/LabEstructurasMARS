.data
    ...
    mensajeMayor: .asciiz "El número mayor es: "  # Mensaje para mostrar el número mayor
    saltoLinea: .asciiz "\n"  # Salto de línea
...
main:
    ...
    # Pedir el primer número y asumirlo como el mayor
    li $v0, 4                   # Prepara la syscall para imprimir cadena (código 4)
    ...
    li $v0, 5                   # Prepara la syscall para leer un entero (código 5)
    syscall                     # Ejecuta la syscall, el entero leído se almacena en $v0
    move $t3, $v0               # Guarda el primer número como el mayor en $t3

    # Loop para leer los siguientes números y encontrar el mayor
    li $t4, 1                   # Inicializa el contador de números ingresados en 1 (ya ingresamos 1)

loop:
    bge $t4, $t0, mostrarMayor  # Si ya se ingresaron todos los números, salta a mostrarMayor
    ...
    ble $t5, $t3, continuar     # Si el número ingresado no es mayor, salta a continuar
    move $t3, $t5               # Si es mayor, actualiza el mayor en $t3
...
mostrarMayor:
    # Mostrar mensaje "El número mayor es: "
    li $v0, 4                   # Prepara la syscall para imprimir cadena (código 4)
    la $a0, mensajeMayor         # Carga la dirección del mensaje en $a0
    syscall                     # Ejecuta la syscall para imprimir el mensaje

    # Mostrar el número mayor
    li $v0, 1                   # Prepara la syscall para imprimir un entero (código 1)
    move $a0, $t3               # Mueve el número mayor a $a0
    syscall                     # Ejecuta la syscall para imprimir el número mayor
